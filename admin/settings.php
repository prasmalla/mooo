...
if (isset($_POST["submit_settings"])) {
    $rArray = getSettings();
    foreach (Array("disallow_empty_user_agents", "persistent_connections", "show_all_category_mag", "show_not_on_air_video", "show_banned_video", "show_expired_video", "new_sorting_bouquet") as $rSetting) {
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="show_all_category_mag">MAG - Show All Categories <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Show All category on MAG devices." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
														...
														<div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="persistent_connections">Persistent Connections</label>
                                                            <div class="col-md-2">
